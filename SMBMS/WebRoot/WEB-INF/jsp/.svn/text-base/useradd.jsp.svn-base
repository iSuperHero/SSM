<%@ page language="java" contentType="text/html; charset=UTF-8"
    pageEncoding="UTF-8"%>
<%@taglib prefix="fm" uri="http://java.sun.com/jsp/jstl/core"%>
...
<div class="right">
        ...
        <div class="providerAdd">
            <form id="userForm" name="userForm" method="post" action="${pageContext.request.contextPath}/user/add.html"
                ...
                <div>
                	<input type="hidden" id="errorinfo" value="${uploadFileError}"/> <!-- Ajax验证 -->
