...
<%@include file="/WEB-INF/jsp/common/head.jsp"%>
        <div class="right">
                ...
                <tr class="firstTr">
                   ...
                   <c:forEach var="user" items="${userList }" varStatus="status">
					<tr>
						...
						<td>
						<span><a class="viewUser" href="${pageContext.request.contextPath}/user/detail.html/${user.id}"><img src="${pageContext.request.contextPath }/statics/images/read.png" alt="查看" title="查看"/></a></span>
						<span><a class="modifyUser" href="${pageContext.request.contextPath}/user/update.html?userid=${user.id}"><img src="${pageContext.request.contextPath }/statics/images/xiugai.png" alt="修改" title="修改"/></a></span>
						<!--<span><a class="deleteUser" href="${pageContext.request.contextPath}/user/delete.html?userid=${user.id}"><img src="${pageContext.request.contextPath }/statics/images/schu.png" alt="删除" title="删除"/></a></span>
        	...
        	<div>
        		<label>出生日期：</label>
        		<input type="text" id="v_birthday" value="" readonly="readonly" Class="Wdate" onclick="WdatePicker();"/>
        	</div>
        	<div>
        		<label>用户电话：</label>
