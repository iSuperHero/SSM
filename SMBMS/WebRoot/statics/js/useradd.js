...
$(function(){
	...
	if(errorinfo.val()=="" || errorinfo.val()==null){
		a_idPicPath.next().html(" * 上传文件大小不能超过500KB * 上传类型必须为：jpg、png、jpeg、pneg ");
	}else{
		a_idPicPath.next().html(errorinfo.val());
	}
	if(errorinfo_wp.val()=="" || errorinfo_wp.val()==null){
		a_workPicPath.next().html(" * 上传文件大小不能超过500KB * 上传类型必须为：jpg、png、jpeg、pneg ");
	}else{
